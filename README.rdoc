...
Clone this repo onto your desktop and run <tt>bundle install</tt> to retrieve the necessary gems. 

== Usage

After cloning the repo and installing the gems, you can run <tt>rails s</tt> to start your local server. The app can then be access at http://localhost:3000
